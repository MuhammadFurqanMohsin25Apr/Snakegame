...
class SNAKE:
    ...
    def update_head_graphics(self):
        head_condition=self.body[1]-self.body[0]
        if head_condition==Vector2(1,0): self.head=self.head_left
        elif head_condition==Vector2(-1,0): self.head=self.head_right
        elif head_condition==Vector2(0,1): self.head=self.head_up
        elif head_condition==Vector2(0,-1): self.head=self.head_down
    def update_tail_graphics(self):
        tail_condition=self.body[-2]-self.body[-1]
        if tail_condition==Vector2(1,0): self.tail=self.tail_left
        elif tail_condition==Vector2(-1,0): self.tail=self.tail_right
        elif tail_condition==Vector2(0,1): self.tail=self.tail_up
        elif tail_condition==Vector2(0,-1): self.tail=self.tail_down
    def snake_move(self):
